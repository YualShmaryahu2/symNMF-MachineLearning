...
// Function to create an output in a specified format
...
// Function to compute the inverse square root of the diagonal degree matrix
...
// Function to perform matrix normalization
...
// Function for symmetric Non-negative Matrix Factorization
